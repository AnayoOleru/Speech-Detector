...
# Text-to-speech
Day 18: A screen reader web-application that can read text on the screen.

https://anayooleru.github.io/Speech-Detector/
...
- Clone the repository to your computer ensure to run the command below in the directory you want to store the project.
    # git clone https://github.com/AnayoOleru/Speech-Detector.git
```
